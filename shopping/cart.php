...
// Make sure $user_id is set before accessing it
if (isset($_SESSION['login']['User_id'])) {
    ...
    if (isset($_GET['product_id'])) {
        ...
        if (isset($_SESSION['cart'][$user_id][$product_id])) {
            ...
            $_SESSION['cart'][$user_id][$product_id] = $item;
        }
...
<!-- Mirrored from themebeyond.com/pre/ganic-prev/ganic-live/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Jun 2023 14:29:15 GMT -->
                    ...
                    <div class="col-12">
                                    ...
                                    <ul class="category-menu">
                                        <li class="menu-item-has-children"><a href="shop.html"><i class="flaticon-groceries"></i> Grocery & Frozen</a>
                                            <ul class="megamenu">
                                                ...
                                                <li class="sub-column-item"><a href="shop.php">Fresh Bread & Bakery</a>
                                                    <ul>
                                                        <li><a href="shop.html">Grassland Dairy</a></li>
                                                        <li><a href="shop.html">Walnuts Max</a></li>
                        ...
                        <div class="mobile-menu">
                            <nav class="menu-box">
                                ...
                                <div class="nav-logo"><a href="index.php"> <a href="index.php"><img src="img/logo/logo.png" alt=""></a>
                                    </a>
                                </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-7">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_SESSION['cart']) && !empty($_SESSION['cart'][$user_id])) {
                                            foreach ($_SESSION['cart'][$user_id] as $product_id => $value) {
                                        ?>
                                                <tr>
                                                    <td class="product-thumbnail"><a href="shop-details.html"><img src="../admin/upload_mau/<?php echo $value['img']; ?>" alt=""></a></td>
                                                    <td class="product-name">
                                                        <h4> <a href="shop-details.php?detail=<?php echo $value['product_id']; ?>"><?php echo $value['name_sp']; ?></a></h4>
                                                    </td>
                                                    <td class="product-price"> <?php echo number_format($value["price"]);  ?>VND</td>
                                                    <td class="product-quantity">
                                                        <form method="post">
                                                            <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
                                                            <input type="number" name="quantity" class="in-num" value="<?php echo $value['quantity']; ?>" min="1" max="100">
                                                            <div class="shop-cart-bottom">
                                                                <div class="continue-shopping">
                                                                    <button class="btn" name="update">update Cart</button>
                                                    ...
                                                    <td class="product-subtotal"><span><?php echo number_format(($value['price'] ?? 0) * ($value['quantity'] ?? 0)); ?> VND</span></td>
                        ...
                        <div class="continue-shopping">
                            <a href="./checkout.php" class="btn">pay</a>
                            ...
                            <div class="footer-contact-list">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <p><a href="https://themebeyond.com/cdn-cgi/l/email-protection#23505653534c515763554644464d0d404c4e"><span class="__cf_email__" data-cfemail="17646267677865635761727072793974787a">[email&#160;protected]</span></a></p>
                                    </li>
                                    <li>
...
<!-- Mirrored from themebeyond.com/pre/ganic-prev/ganic-live/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Jun 2023 14:29:16 GMT -->
