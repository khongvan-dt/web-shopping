...
<!-- Mirrored from themebeyond.com/pre/ganic-prev/ganic-live/shop-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Jun 2023 14:29:16 GMT -->
                ...
                <div class="row">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="item-one" role="tabpanel" aria-labelledby="item-one-tab">
                                        <div class="shop-details-img">
                                            <img src="../admin/upload_mau/<?php echo $list["img"]; ?>" alt="<?php echo $list["name_sp"]; ?>">
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="shop-details-content">
                            <h4 class="title"> <?php echo $list["name_sp"]; ?></h4>

                            <div class="shop-details-price">
                                <h2 class="price"><?php number_format($list["price"]); ?></h2>
                            </div>
                            <p><?php $list['description'] ?></p>
                                    ...
                                    <div class="product-desc-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-9 col-md-7">
                                                <h5 class="small-title"><?php echo $list["name_sp"]; ?></h5>
                            ...
                            <div class="col-3">
                                <div class="sp-product-item mb-20">
                                    ...
                                    <div class="sp-product-content">
                                        ...
                                        <span class="product-status"><?php echo number_format($product["price"]); ?> VND</span>
                            ...
                            <div class="footer-contact-list">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <p><a href="https://themebeyond.com/cdn-cgi/l/email-protection#a2d1d7d2d2cdd0d6e2d4c7c5c7cc8cc1cdcf"><span class="__cf_email__" data-cfemail="26555356564954526650434143480845494b">[email&#160;protected]</span></a></p>
                                    </li>
                                    <li>
...
<!-- Mirrored from themebeyond.com/pre/ganic-prev/ganic-live/shop-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Jun 2023 14:29:19 GMT -->
