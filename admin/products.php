        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Chọn Loại Mặt Hàng Muốn Thêm Sản Phẩm</h1>
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                    <a href="./detail.php?detail=<?php echo $row['category_id']; ?>" class="btn btn-primary"> <?php echo $row['category_name'] ?>
                                    </a>
                                <?php } ?>
                            </div>
