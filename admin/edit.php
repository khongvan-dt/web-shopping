...
if (empty($_SESSION['loggedin'])) {
    ...
    //     $Update = "UPDATE categories SET category_name VALUES (?) WHERE category_id = $category_id ";
    //     $stmt = mysqli_prepare($conn, $Update);
    //     mysqli_stmt_bind_param($stmt, "s", $name_sp);
    ...
    if (isset($_POST['save'])) {
        ...
        $stmt = mysqli_prepare($conn, $Update);
        mysqli_stmt_bind_param($stmt, "si", $name_sp, $category_id);
                        ...
                        <form action="" method="post">
                            ...
                            <div class="card-body">
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <th>Tên Loại SP : <input type="text" name="name_sp" value="<?php echo $row['category_name']; ?>"></th>
